...
// function is likely used to handle a GET request.
const teacher_viewall_get = async (req, res) => {
    //await to fetch all documents from a MongoDB collection named Student
    const allStudents = await Student.find() 
    //renders a view template named "teacher/viewall" 
